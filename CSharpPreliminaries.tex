...
Lastly, value types are always initilized. For numerical types, C\# gurrantees contain 0; if some value type contains a reference type field, it will hold a null value.
