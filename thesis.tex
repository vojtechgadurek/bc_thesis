...
\include{chap01}
\include{CSharpPreliminaries}
\include{LittleSharp}
\include{FlashHash}
\include{RedaFasta}
\include{SymmetricDifferenceFinder}
\include{Experiments}
\include{epilog}
...
\begin{description}
    \item[MOp/s] mega operations per seconds
    \item[MH/s] mega hashes per seconds
    \item[whp] with high probability
    \item[HWP] Houen-Waltzer-Pagh recovery algorithm
    \item[IBLT] Invertible Bloom Lookup Table
